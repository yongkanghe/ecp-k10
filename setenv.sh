...
export MY_CLUSTER=hcp4yong1         #Customize your cluster name
...
export MY_ZONE=ap-southeast-1c           #Customize your favorite zone
...
export MY_K8S_VERSION=1.20              #Customize your Kubernetes Version
